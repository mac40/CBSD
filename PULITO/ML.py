...
def prev_to_csv(csv_in,scaler=scaler,model=model):
...
previsioni=prev_to_csv("non_training_data_preproc/preproc_video_test_2.csv")
privioni.to_csv("prova_validation.csv")
